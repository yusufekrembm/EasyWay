...
public class Credentials {
    public static final String NEW_BASE_API_URL = "https://newsapi.org";
    public static final String NEWS_API_KEY = "";
    public static final String NEWS_API_VERSION = "v2";
    ...
    public static final String MOVIE_YT_IMG_URL = "https://i3.ytimg.com/vi/";
    public static final String MOVIE_YT_WATCH_URL = "https://www.youtube.com/watch?v=";
    public static final int MOVIE_API_VERSION = 3;
    public static final String YOUTUBE_BASE_API_URL = "https://youtube.googleapis.com/youtube/";
    public static final String YOUTUBE_API_VERSION = "v3";
